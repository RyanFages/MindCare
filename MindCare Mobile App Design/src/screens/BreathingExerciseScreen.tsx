...
const BreathingExerciseScreen = ({ onBack }: BreathingExerciseScreenProps) => {
    ...
    const steps = [
        {
            label: t("breathing.step.inhale"),
            instruction: t("breathing.step.inhale.instruction"),
            duration: 4,
            scale: 1.6,
            color: "bg-primary/20",
        ...
        {
            label: t("breathing.step.hold"),
            instruction: t("breathing.step.hold.instruction"),
            duration: 4,
            scale: 1.6,
        ...
        {
            label: t("breathing.step.exhale"),
            instruction: t("breathing.step.exhale.instruction"),
            duration: 6,
            scale: 1,
            color: "bg-accent/20",
                        ...
                        >
                            ...
                            <div className="flex gap-3 mb-10">
                                {steps.map((s, i) => (
                                    <div
                                        key={i}
                                        className={`px-4 py-2 rounded-full border text-[13px] font-medium ${s.color} ${s.borderColor}`}
                                    >
                                        {s.label}
                                    </div>
                                ))}
                    ...
                    {finished && (
                        ...
                        >
                            ...
                            <TextBody className="text-muted-foreground mb-10 max-w-xs">
                                {t("breathing.finished.description")}
                            </TextBody>
