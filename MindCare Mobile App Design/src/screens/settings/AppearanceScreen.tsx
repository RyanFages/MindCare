...
const AppearanceScreen = ({ onBack }: { onBack: () => void }) => {
    ...
    return (
        <Screen>
            <TopBar title={t("appearance.title")} showBack onBack={onBack} />
                ...
                <div className="mt-8 flex justify-center">
                    <div
                        className={cn(
                            ...
                            resolvedTheme === "dark"
                                ? "bg-foreground border-muted-foreground"
                                : "bg-card border-card",
                        )}
                    >
                        <div
                            className={cn(
                                "w-20 h-2 bg-current rounded-full opacity-20",
                                resolvedTheme === "dark"
                                    ? "text-card"
                                    : "text-foreground",
                            )}
                        ...
                        <div
                            className={cn(
                                "w-full h-10 rounded-full opacity-20",
                                resolvedTheme === "dark"
                                    ? "bg-card"
                                    : "bg-foreground",
                            )}
